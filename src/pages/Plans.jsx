...
import { FaCheck, FaTimes, FaSun, FaMoon, FaTwitter, FaFacebook, FaLinkedin, FaInstagram } from "react-icons/fa";
...
const Plans = () => {
	...
	return (
		<>
			<SEO
				title="Pricing Plans"
				description="Choose from our flexible pricing plans designed to fit businesses of all sizes. Start with a 14-day free trial."
				keywords={["email pricing", "marketing plans", "email packages", "marketing pricing", "free trial"]}
				canonical="https://cropmail.onrender.com/price"
			/>
						...
						<div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
							<div>
								...
								<p className="text-gray-600 mb-4">
									Revolutionizing email marketing with AI-powered solutions for businesses of all
									sizes.
								</p>

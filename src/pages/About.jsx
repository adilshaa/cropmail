...
const About = () => {
	...
	return (
		<>
			<SEO
				title="About Us"
				description="Learn about Cropmail's mission to revolutionize email marketing through innovative solutions and cutting-edge technology."
				keywords={[
					"email marketing",
					"about cropmail",
					"marketing team",
				...
				canonical="https://cropmail.onrender.com/about"
			/>
				...
				<div className="relative pt-24 pb-32 overflow-hidden">
					...
					<div className="relative z-10 max-w-6xl mx-auto px-4">
						<div className="text-center">
							...
							>
								Revolutionizing email marketing through innovative solutions and cutting-edge
								technology.
							</p>
						</div>
					</div>
						...
						<div className="grid md:grid-cols-2 gap-12 items-center">
							<div>
								...
								<p className={`text-lg mb-6 ${isDarkTheme ? "text-gray-300" : "text-gray-600"}`}>
									To empower businesses with intelligent email marketing solutions that drive growth

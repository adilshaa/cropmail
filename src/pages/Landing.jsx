    ...
    return (
        <div className={`${isDarkTheme ? "bg-gray-900 text-white" : "bg-white text-gray-900"} overflow-hidden`}>
            ...
            <main className="min-h-screen flex flex-col items-center justify-center relative px-5 sm:px-4">
                ...
                <div className="relative backdrop-blur-lg bg-white/10 p-8 md:p-12 rounded-2xl shadow-xl max-w-5xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 gap-8 mb-8">
                        <div>
                            <p className={`text-lg md:text-xl ${isDarkTheme ? "text-gray-300" : "text-gray-700"} mb-6 leading-relaxed`}>
                                Transform your email campaigns with AI-powered automation, real-time analytics, and personalized content delivery.
                            </p>
                        ...
                        <div className="space-y-4">
                            <div className={`${isDarkTheme ? "bg-gray-800/50" : "bg-white/50"} p-4 rounded-lg backdrop-blur-sm`}>
                                <h3 className="font-bold mb-2 flex items-center">
                                    <FaMailBulk className="text-blue-500 mr-2" /> Smart Automation
                                </h3>
                                <p className="text-sm opacity-80">Automate your email campaigns with AI-driven scheduling and segmentation</p>
                            </div>
                            <div className={`${isDarkTheme ? "bg-gray-800/50" : "bg-white/50"} p-4 rounded-lg backdrop-blur-sm`}>
                                <h3 className="font-bold mb-2 flex items-center">
                                    <FaCheck className="text-green-500 mr-2" /> Advanced Analytics
                                </h3>
                                <p className="text-sm opacity-80">Track opens, clicks, and conversions in real-time with detailed insights</p>
                            </div>
                            <div className={`${isDarkTheme ? "bg-gray-800/50" : "bg-white/50"} p-4 rounded-lg backdrop-blur-sm`}>
                                <h3 className="font-bold mb-2 flex items-center">
                                    <FaUser className="text-purple-500 mr-2" /> Personalization
                                </h3>
                                <p className="text-sm opacity-80">Deliver personalized content to each subscriber automatically</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        ...
                        <button className={`px-8 py-4 border-2 ${isDarkTheme ? "border-gray-700" : "border-gray-300"} rounded-full font-bold hover:border-blue-500 transition-colors w-full sm:w-auto`}>
                            Watch Demo
                        </button>
                    </div>
                </div>
            ...
            <section className="py-20">
                <div className="max-w-6xl mx-auto px-4">
                    <h3 className={`text-2xl font-bold text-center mb-4 ${isDarkTheme ? 'text-white' : 'text-gray-900'}`}>
                        Integrate with Your Favorite Tools
                    </h3>
                    <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
                        Seamlessly connect with over 100+ popular tools and platforms to streamline your workflow and maximize productivity
                    </p>
            ...
            <section className={`py-20 ${isDarkTheme ? 'bg-gray-800' : 'bg-blue-50'}`}>
                <div className="max-w-4xl mx-auto text-center px-4">
                    ...
                    <p className="text-lg mb-8 text-gray-600">Join thousands of marketers who have already upgraded their email game</p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
                        ...
                        <div>
                            ...
                            <ul className="space-y-2">
                                ...
                                <li><a href="#" className="text-gray-600 hover:text-blue-500">Status</a></li>

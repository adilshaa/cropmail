		...
		<div className={`${isDarkTheme ? "bg-gray-900 text-white" : "bg-white text-gray-900"} min-h-screen`}>
			...
			<div className="max-w-6xl mx-auto px-4 pt-24 pb-12">
				<div className={`${isDarkTheme ? "bg-gray-800" : "bg-white"} rounded-lg shadow-xl p-8`}>
					<h1
						className={`text-4xl font-bold mb-8 bg-gradient-to-r from-blue-500 to-purple-500 bg-clip-text text-transparent`}
					>
						Privacy Policy
					</h1>
					<div className={`space-y-8 ${isDarkTheme ? "text-gray-300" : "text-gray-600"}`}>
						<p className="mb-4 leading-relaxed">
							Your privacy is important to us. It is Cropmail's policy to respect your privacy regarding
							any information we may collect from you across our website, https://cropmail.onrender.com,
						...
						<div className="space-y-4">
							...
							<p className="leading-relaxed">
								...
								maintain our website, improve, personalize, and expand our website, understand and
								analyze how you use our website, develop new products, services, features, and
